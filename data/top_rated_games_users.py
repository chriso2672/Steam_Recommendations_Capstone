...
top_rated = "https://steamdb.info/stats/gameratings/"

top_rated_user_ids = get_user_ids(top_rated, '1K',  100)
driver.close()



# Store data (serialize)
with open('trui.pickle', 'wb') as handle:
    pickle.dump(top_rated_user_ids, handle, protocol=pickle.HIGHEST_PROTOCOL)
