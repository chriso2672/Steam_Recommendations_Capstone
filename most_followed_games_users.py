...
most_followed = "https://steamdb.info/stats/mostfollowed/"

most_followed_user_ids = get_user_ids(most_followed, '1,000',  100)
driver.close()

# Store data (serialize)
with open('mfui.pickle', 'wb') as handle:
    pickle.dump(most_followed_user_ids, handle, protocol=pickle.HIGHEST_PROTOCOL)
